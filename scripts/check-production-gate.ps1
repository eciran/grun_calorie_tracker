...
$secretChecks = @(
    ...
    (Check-Env "GRUN_BREVO_TEMPLATE_EMAIL_VERIFICATION_EN"),
    (Check-Env "GRUN_BREVO_TEMPLATE_EMAIL_VERIFICATION_TR"),
    (Check-Env "GRUN_BREVO_TEMPLATE_PASSWORD_RESET_EN"),
    (Check-Env "GRUN_BREVO_TEMPLATE_PASSWORD_RESET_TR"),
    (Check-Env "GRUN_BREVO_TEMPLATE_SUBSCRIPTION_FEATURE_CHANGE_EN"),
    (Check-Env "GRUN_BREVO_TEMPLATE_SUBSCRIPTION_FEATURE_CHANGE_TR"),
    (Check-Env "GRUN_BREVO_TEMPLATE_ADMIN_INVITATION_EN"),
    (Check-Env "GRUN_BREVO_TEMPLATE_ADMIN_INVITATION_TR"),
    (Check-Env "GRUN_BREVO_TEMPLATE_ADMIN_PASSWORD_CHANGED_EN"),
    (Check-Env "GRUN_BREVO_TEMPLATE_ADMIN_PASSWORD_CHANGED_TR")
)
