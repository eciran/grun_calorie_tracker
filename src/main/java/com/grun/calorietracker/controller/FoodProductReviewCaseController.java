...
import com.grun.calorietracker.service.FoodProductReviewCaseService; import com.grun.calorietracker.service.support.ProductIntakeRolloutPolicy; import jakarta.validation.constraints.*;
import lombok.RequiredArgsConstructor; import org.springframework.data.domain.PageRequest; import org.springframework.http.ResponseEntity;
...
public class FoodProductReviewCaseController {
 private final UserRepository users; private final FoodProductReviewCaseRepository cases; private final FoodProductReviewCaseService service; private final ProductIntakeRolloutPolicy rolloutPolicy;
 ...
 private UserEntity user(UserDetails p){return users.findByEmail(p.getUsername()).orElseThrow(()->new InvalidCredentialsException("Invalid credential"));}
