...
public enum AdvancedFastingErrorCode {
    ...
    INVALID_FASTING_SCHEDULE_EXCEPTION(HttpStatus.BAD_REQUEST),
    FASTING_SCHEDULE_EXCEPTION_LOCKED(HttpStatus.CONFLICT),
    FASTING_SCHEDULE_EXCEPTION_NOT_FOUND(HttpStatus.NOT_FOUND),
    REDUCED_CALORIE_OCCURRENCE_REQUIRED(HttpStatus.BAD_REQUEST);
