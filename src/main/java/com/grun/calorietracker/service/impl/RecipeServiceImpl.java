...
public class RecipeServiceImpl implements RecipeService {
    ...
    public RecipeDto getRecipe(String email, Long recipeId) {
        return toDto(getOwnedRecipe(email, recipeId));
    }
    ...
    private void applyRequest(RecipeEntity recipe, RecipeRequestDto request, UserEntity user) {
        ...
        recipe.setImageUrl(trimToNull(request.getImageUrl()));
    ...
    private RecipeDto toDto(RecipeEntity recipe) {
    ...
    private RecipeEntity getOwnedRecipe(String email, Long recipeId) {
        return recipeRepository.findByIdAndOwnerUserAndArchivedFalse(recipeId, getUser(email))
                .orElseThrow(() -> new ResourceNotFoundException("Recipe not found"));
    }
