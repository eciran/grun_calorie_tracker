...
ALTER TABLE subscription_plan_features
    ...
    CHECK (feature IN (
        ...
        'WATER_TRACKING','WORKOUT_LOGGING','SAVED_MEAL_TEMPLATES','GROCERY_LIST',
        'RECIPE_BUILDER','PUBLIC_RECIPE_LIBRARY','NEXT_MEAL_SUGGESTIONS',
        'ADVANCED_MACRO_TARGETS','MICRONUTRIENT_DETAILS','MICRONUTRIENT_ANALYTICS',
        'DATA_EXPORT','FASTING_BASIC','FASTING_ADVANCED','AI_MEAL_DRAFTS',
        'AI_WORKOUT_PLANNER','AI_RECIPE_GENERATION','AI_MEAL_PREPARATION_GUIDE',
...
VALUES
    ('FREE', 'GROCERY_LIST', FALSE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('PLUS', 'GROCERY_LIST', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('PRO', 'GROCERY_LIST', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP)
