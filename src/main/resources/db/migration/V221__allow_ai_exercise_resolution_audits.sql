...
'ADMIN_PASSWORD_RESET_REQUEST','ADMIN_PASSWORD_RESET_CONFIRM','ADMIN_MFA_STATUS_UPDATE','ADMIN_MFA_ENROLL',
'ADMIN_MFA_DISABLE','ADMIN_MFA_REAUTHENTICATE','ADMIN_MFA_FAILURE','ADMIN_MFA_RECOVERY_CODE_USE',
...
'RUNTIME_RECORD_CREATE','RUNTIME_JOB_RETRY','FASTING_OPERATIONS_CONFIG_UPDATE',
'AI_EXERCISE_RESOLVE','AI_EXERCISE_DISMISS'
));
...
'GDPR_REQUEST','PRODUCTION_VERIFICATION','FASTING_GOVERNANCE','AI_EXERCISE_RESOLUTION'
));
