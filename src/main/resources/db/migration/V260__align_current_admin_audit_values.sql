-- Extend audit constraints without changing existing audit records.
...
ALTER TABLE admin_action_audits ADD CONSTRAINT chk_admin_action_audits_action_type CHECK (action_type IN (
    ...
    'AI_QUOTA_REFUND',
    'AI_REQUEST_INSPECT',
    'AI_OPERATIONS_POLICY_UPDATE',
    'AI_OPERATIONS_DEPLOYMENT_ROLLBACK',
    ...
    'NOTIFICATION_DEFINITION_UPDATE',
    'SUBSCRIPTION_NOTIFICATION_POLICY_PUBLISH',
    'SUBSCRIPTION_NOTIFICATION_EMERGENCY_STOP',
    'PROMO_CREATE',
    'PROMO_UPDATE',
    'PROMO_ACTIVATE',
    'PROMO_DEACTIVATE',
    ...
    'ADMIN_MFA_ENROLL',
    'ADMIN_MFA_DISABLE',
    'ADMIN_MFA_REAUTHENTICATE',
    'ADMIN_MFA_FAILURE',
    'ADMIN_MFA_RECOVERY_CODE_USE',
    'ADMIN_SESSION_CREATE',
    'RECOVERY_OWNER_LOGIN',
    'ADMIN_SESSION_REVOKE',
    'ADMIN_OTHER_SESSIONS_REVOKE',
    'ADMIN_APPROVAL_REQUEST',
    'ADMIN_APPROVAL_APPROVE',
    'ADMIN_APPROVAL_REJECT',
    'ADMIN_APPROVAL_EXECUTION_FAILED',
    'GDPR_REQUEST_UPDATE',
    'PRODUCTION_VERIFICATION_RECORD',
    'CATALOG_EXERCISE_CREATE',
    'CATALOG_EXERCISE_UPDATE',
    'CATALOG_EXERCISE_REVIEW',
    'CATALOG_REVIEW_ASSIGNMENT',
    'RUNTIME_POLICY_UPDATE',
    'RUNTIME_POLICY_ROLLBACK',
    'RUNTIME_RECORD_CREATE',
    'RUNTIME_JOB_RETRY',
    'FASTING_OPERATIONS_CONFIG_UPDATE',
    'AI_EXERCISE_RESOLVE',
    'AI_EXERCISE_DISMISS',
    'MEAL_REMINDER_POLICY_DRAFT',
    'MEAL_REMINDER_POLICY_PUBLISH',
    'MEAL_REMINDER_POLICY_ROLLBACK',
    'MEAL_REMINDER_DEFINITION_PUBLISH',
    'MEAL_REMINDER_EMERGENCY_STOP',
    'MEAL_REMINDER_REOPEN',
    'MEAL_REMINDER_TEST_SEND',
    'FREE_PROMOTION_POLICY_UPDATE'
));
