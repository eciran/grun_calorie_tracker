...
VALUES
    ('FREE', 'AI_MEAL_DRAFTS', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('PLUS', 'AI_MEAL_DRAFTS', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('PRO', 'AI_MEAL_DRAFTS', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('FREE', 'AI_INSIGHTS', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('PLUS', 'AI_INSIGHTS', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP),
    ('PRO', 'AI_INSIGHTS', TRUE, CURRENT_DATE, CURRENT_TIMESTAMP)
...
JOIN subscription_plan_features f
   ...
   AND f.feature IN ('AI_MEAL_DRAFTS', 'AI_INSIGHTS')
   AND f.enabled = TRUE
