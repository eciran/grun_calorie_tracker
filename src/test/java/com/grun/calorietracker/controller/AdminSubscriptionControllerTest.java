...
class AdminSubscriptionControllerTest {
    ...
    void updateUserSubscription_whenDirectMutationIsDisabled_returnsForbidden() throws Exception {
    ...
    @Test
    @WithMockUser(username = "admin@test.com", authorities = {"ROLE_ADMIN", "ADMIN_PERMISSION_FINANCE_READ", "ADMIN_PERMISSION_FINANCE_MANAGE"})
    void applyCurrentFeatureMatrixToUser_whenDirectMutationIsDisabled_returnsForbidden() throws Exception {
    ...
    @Test
    @WithMockUser(username = "admin@test.com", authorities = {"ROLE_ADMIN", "ADMIN_PERMISSION_FINANCE_READ", "ADMIN_PERMISSION_FINANCE_MANAGE"})
    void resetUserAiQuota_whenDirectMutationIsDisabled_returnsForbidden() throws Exception {
        SubscriptionDto response = new SubscriptionDto();
        response.setPlanType(SubscriptionPlan.PLUS);
        response.setStatus(SubscriptionStatus.ACTIVE);
    ...
    @Test
    @WithMockUser(username = "admin@test.com", authorities = {"ROLE_ADMIN", "ADMIN_PERMISSION_FINANCE_READ", "ADMIN_PERMISSION_FINANCE_MANAGE"})
    void grantAiAddonQuota_whenDirectMutationIsDisabled_returnsForbidden() throws Exception {
