...
class AdminProductIntakeReviewActionsTest {
    ...
    private final com.grun.calorietracker.service.support.ProductIntakeApplyGate applyGate = mock(com.grun.calorietracker.service.support.ProductIntakeApplyGate.class);
    private final com.grun.calorietracker.service.support.FoodProductIntakeMetrics intakeMetrics = mock(com.grun.calorietracker.service.support.FoodProductIntakeMetrics.class);
    ...
    void setup() {
        ...
        service.setApplyGate(applyGate);
        service.setIntakeMetrics(intakeMetrics);
    ...
    void approvedNewCandidatePublishesOnlyThroughCentralService() {
        ...
        verify(applyGate).requirePublishable(reviewCase, food);
