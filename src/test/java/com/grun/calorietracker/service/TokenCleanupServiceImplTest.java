...
class TokenCleanupServiceImplTest {
    ...
    void cleanupExpiredTokens_deletesExpiredTokensFromAllTokenTables() {
        ...
        AccountLinkAuthorizationRepository accountLinkAuthorizationRepository = mock(AccountLinkAuthorizationRepository.class);
        TokenCleanupServiceImpl service = new TokenCleanupServiceImpl(
                refreshTokenRepository,
                passwordResetTokenRepository,
                emailVerificationTokenRepository,
                accountLinkAuthorizationRepository
        );
        ...
        when(accountLinkAuthorizationRepository.deleteByExpiresAtBefore(any(LocalDateTime.class))).thenReturn(5L);
        ...
        assertThat(result.accountLinkAuthorizations()).isEqualTo(5L);
        assertThat(result.totalDeleted()).isEqualTo(14L);
        ...
        verify(accountLinkAuthorizationRepository).deleteByExpiresAtBefore(any(LocalDateTime.class));
    }
}
