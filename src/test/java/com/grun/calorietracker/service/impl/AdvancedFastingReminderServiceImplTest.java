...
class AdvancedFastingReminderServiceImplTest {
 ...
 @BeforeEach void setup(){ MockitoAnnotations.openMocks(this); service=new AdvancedFastingReminderServiceImpl(programs,occurrences,deliveries,execution,notifications,push,new UserTimeZoneSupport());
