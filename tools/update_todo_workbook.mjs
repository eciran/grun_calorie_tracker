...
const rows = [
  ...
  [null, "Advanced Fasting", "Gelismis fasting urun tasarimi ve uygulamasi", "Basic/advanced urun siniri, 5:2 haftalik dusuk kalorili gun modeli, 24 saat MVP guvenlik tavani, eligibility/onay, versiyonlu haftalik program, reminder, analytics, admin governance ve abonelik kapsami sekiz sprint halinde planlandi.", 0.2, "Planlandi", "docs/ADVANCED_FASTING_SPRINT_PLAN_2026-07-26.md izlenecek. Her sprint acceptance testlerinden sonra ayri commitlenecek; FREE basic, PLUS advanced, PRO cross-domain analytics onerisi uygulanacak. Klinik/legal/privacy/store kabul kontrolleri production oncesi dis gate olarak kalacak."],
  ...
  [null, "Grocery List", "Meal plan kaynakli kalici ve ucretli alisveris listesi", "Mevcut backend meal plan icindeki FOOD_ITEM ve RECIPE girdilerinden read-only toplam uretebiliyor; mobilde plan detayindan acilan basit gorunum mevcut. Hedef urun karari: ayri GROCERY_LIST entitlement, FREE kapali, PLUS ve PRO acik.", 0.25, "Beklemede", "docs/GROCERY_LIST_MVP_PLAN_AND_HOLD_REPORT_2026-07-28.md izlenecek. Backend 403 entitlement, kalici checklist, manuel urun, kategori, miktar override, exclude/refresh merge, audit ve mobil handoff sprintleri urun sahibi yeniden aktif edene kadar ON HOLD."],
