...
const rows = [
  ...
  [null, "Production Readiness", "Prod profile, logging, secrets, deployment checklist", "Production ortamına çıkış için config, observability, secret ve deployment hazırlığı.", 0.45, "Kısmi", "Docker/local run, Flyway, Redis rate-limit altyapısı, production gate ve smoke scriptleri var. AWS deployment, secret inventory, monitoring alarm eşikleri ve prod profile sertleştirme eksik."],
