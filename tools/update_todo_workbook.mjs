...
const rows = [
  ...
  [null, "Advanced Fasting", "Gelismis fasting urun tasarimi ve uygulamasi", "Mevcut fasting plan, session, history, streak ve reminder altyapisi baz alinarak 5:2, haftalik program, uzun fasting guvenlik kurallari, gelismis istatistikler ve abonelik kapsami analiz edilecek.", 0.15, "Planlandi", "Once urun ve guvenlik analizi yapilacak. Haftalik tekrar modeli, uzun fasting uyarilari, plan gecisleri, reminder davranisi, Plus/Pro entitlement karari ve mobil handoff sonrasinda uygulanacak."],
  ...
  [null, "Micronutrient Progress Analytics", "Progress ekraninda Plus/Pro mikro besin trendleri", "Gunluk consumed, target ve remaining micronutrient verileri mevcut. Progress icinde vitamin/mineral hedef karsilama, ortalama alim, eksik veri kapsami ve zaman icindeki trendler analiz edilecek.", 0.3, "Planlandi", "MICRONUTRIENT_DETAILS Plus/Pro entitlement'i authoritative olacak. Yalnizca Pro ADVANCED_ANALYTICS endpointine gomulmeyecek; Plus erisimini koruyan ayri veya kosullu backend kontrati kurulacak. Sodium, potassium, calcium, iron, magnesium, zinc ve A/C/D/E/B12 vitaminleri; null veri, coverage, hedef yuzdesi ve guvenli yorum kurallariyla sunulacak."],
