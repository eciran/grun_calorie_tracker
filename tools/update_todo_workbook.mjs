...
const rows = [
  ...
  [null, "RevenueCat Payment Integration", "App Store / Google Play subscription webhook ve entitlement eşleşmesi", "Mobil subscription ödemelerinin RevenueCat ile backend subscription modeline bağlanması.", 0.85, "Kısmi", "RevenueCat branch pushlandı. Test Store ürünleri, GRUN Plus/GRUN Pro entitlement display name'leri, default offering package mapping'leri ve eski wizard temizliği tamamlandı. App Store/Google Play product eşleşmeleri, webhook secret ve sandbox purchase/refund testleri bekliyor."],
