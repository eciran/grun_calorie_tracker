...
const rows = [
  ...
  [null, "Pro Energy Balance Analytics", "Pro kullanici icin kanonik enerji dengesi ve modellenmis kilo degisimi", "Sprint 1-4 tamamlandi: contract/policy/guard, kanonik health enerji modeli, ortak BMR/TDEE fallback zinciri; versioned 7700 kcal/kg modeli, yapilandirilabilir belirsizlik araligi ve gecmis tartimlardan observed-model farki eklendi.", 0.72, "Kismi", "Sprint 5 meal/activity breakdown, coverage ve insight assembly yapisini; sonraki sprint endpoint ve release testlerini tamamlayacak."],
