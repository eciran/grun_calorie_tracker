...
const rows = [
  ...
  [null, "Pro Energy Balance Analytics", "Pro kullanici icin kanonik enerji dengesi ve modellenmis kilo degisimi", "Sprint 1 tamamlandi: null-safe response sozlesmesi, versioned static energy-density policy, balance/confidence kurallari, user-local range guard ve ADVANCED_ANALYTICS route korumasi eklendi.", 0.2, "Kismi", "Sprint 2 health daily-energy modelini ve provider deduplication yapisini; sonraki sprintler expenditure resolver, profile TDEE, weight model, breakdown, insights, endpoint ve release testlerini tamamlayacak."],
