...
const rows = [
  ...
  [null, "Push Notification Provider", "Provider bagimsiz push token ve delivery altyapisi", "User push token register/revoke/list endpointleri, delivery log, LOG/Expo/FCM/OneSignal provider clientlari, invalid-token cleanup, admin monitoring ve prod config guard hazir.", 0.9, "Kismi", "Kod tarafi tamamlandi. Kalan isler gercek provider credentialleriyle sandbox/live smoke, mobil cihaz token lifecycle testi ve gerekiyorsa FCM OAuth/service-account stratejisi."],
