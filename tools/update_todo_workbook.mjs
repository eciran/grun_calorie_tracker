...
const rows = [
  ...
  [null, "Food ve Exercise Modulleri", "Yiyecek ve egzersiz giris/analiz altyapisi", "Food log, portion unit, custom food, favorites, recent meals, meal template, duration/reps/sets/weight/distance destekli exercise log, source history ve dashboard summary akislari backend tarafinda hazir.", 0.94, "Kismi", "Genis ve dogrulanmis food catalog, gercek regional import, mobil UI entegrasyonu ve buyuk veri performans testi eksik."],
  ...
  [null, "Food Database Bulk Import", "Open Food Facts import ve katalog buyutme", "CSV/import pipeline, admin import, kalite alanlari, duplicate/review altyapisi ve region pilot import scripti hazir.", 0.42, "Kismi", "10k+ gercek regional import bilincli olarak ertelendi. Pilot dataset ve runbook ile kontrollu ilerleniyor."],
  [null, "Meal Planner / Grocery List", "Haftalik yemek plani ve alisveris listesi temeli", "Meal plan CRUD, duplicate/copy akisi, food/recipe item destegi, plan archive, serving-size aware grocery list aggregation, controller coverage ve mobil kontrat dokumani hazir.", 0.7, "Kismi", "Mobil planlama ekrani, saved plan templates UI ve gercek kullanici akisi testi eksik."],
  ...
  [null, "Mobile API Contract", "Mobil uygulama icin backend sozlesmesi", "Auth, startup, onboarding, food/water/fasting, recipe, subscription, region, health, AI draft, meal planner, target micros, notification preference ve product detail kontratlari guncel.", 0.97, "Kismi", "Gercek mobil entegrasyon, native health payload testi, push provider ve store purchase flow testleri eksik."],
  ...
  [null, "Notifications", "In-app notification ve tercih altyapisi", "Notification list/read/read-all, system alerts, water/fasting in-app reminders ve account-level meal/hydration/fasting/recipe/AI/weekly report preferences hazir.", 0.86, "Kismi", "Push notification provider ve mobile permission/token lifecycle eksik."],
