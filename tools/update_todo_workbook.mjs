...
const rows = [
  ...
  [null, "Pro Energy Balance Analytics", "Pro kullanici icin kanonik enerji dengesi ve modellenmis kilo degisimi", "Sprint 1-5 tamamlandi: contract/policy/guard, kanonik health enerji modeli, ortak BMR/TDEE fallback zinciri; versioned 7700 kcal/kg modeli, belirsizlik araligi, observed-model farki, gunluk seri, coverage, meal/activity breakdown ve guvenli insight kodlari eklendi.", 0.86, "Kismi", "Sprint 6 Pro-korumali endpoint, servis orkestrasyonu, sorgu optimizasyonu, OpenAPI/handoff ve release testlerini tamamlayacak."],
