...
const rows = [
  ...
  [null, "Pro Energy Balance Analytics", "Pro kullanici icin kanonik enerji dengesi ve modellenmis kilo degisimi", "Sprint 1-3 tamamlandi: contract/policy/guard; kanonik health enerji modeli; ortak Mifflin-St Jeor/Katch-McArdle hesaplayicisi ve HEALTH_TOTAL, HEALTH_RESTING_PLUS_ACTIVE, HEALTH_ACTIVE_PLUS_PROFILE_RESTING, PROFILE_TDEE fallback zinciri eklendi.", 0.6, "Kismi", "Sprint 4 modeled/observed weight change ve guven araligini; sonraki sprintler breakdown, insights, endpoint ve release testlerini tamamlayacak."],
