...
const rows = [
  ...
  [null, "Pro Energy Balance Analytics", "Pro kullanici icin kanonik enerji dengesi ve modellenmis kilo degisimi", "Sprint 1-2 tamamlandi: response sozlesmesi, versioned policy, entitlement/range guard; active/resting/total health enerji alanlari, legacy uyumluluk, provider-event idempotency ve providerlar arasi toplamayi engelleyen kanonik gunluk enerji secimi eklendi.", 0.4, "Kismi", "Sprint 3 kanonik expenditure resolver ve profile TDEE fallback yapisini; sonraki sprintler weight model, breakdown, insights, endpoint ve release testlerini tamamlayacak."],
